...
def main(user):
    ...
    html = get_html(url)
    urls = get_urls(html)
    dirpath = r'C:\Users\Big data\Desktop\pictures\{0}'.format(user)
    ...
    for i in range(len(urls)):
        ...
        try:
            ...
            file_path = r'C:\Users\Big data\Desktop\pictures\{0}\{1}.{2}'.format(user, md5(content).hexdigest(), urls[i][-43:-40])
